...
void MainWindow::on_pushButton_clicked()
{
    ...
    QString filter = "Program File(*.h *.cpp);;txt File(*.txt);;All File(*.*)"; //文件过滤器
...
void MainWindow::on_action_Shp_triggered()
{
    ...
    poDS = (GDALDataset*) GDALOpenEx( "D:/Document/Qt/ConsoleDemo/school.shp", GDAL_OF_VECTOR, NULL, NULL, NULL );
    if( poDS == NULL )
    {
        printf( "Open failed.\n" );
        exit( 1 );
